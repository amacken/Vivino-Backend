...
class WinesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create wine" do
    assert_difference('Wine.count') do
      post wines_url, params: { wine: { color: @wine.color, country: @wine.country, name: @wine.name, region: @wine.region, vintage: @wine.vintage, winery: @wine.winery } }, as: :json
    end
  ...
  test "should update wine" do
    patch wine_url(@wine), params: { wine: { color: @wine.color, country: @wine.country, name: @wine.name, region: @wine.region, vintage: @wine.vintage, winery: @wine.winery } }, as: :json
    assert_response 200
  end
